...
local styles = require("ui.styles.button_primary_silent")

---@class custom_button_primary_silent : druid.base_component
local M = component.create("custom_button_primary_silent")
